...
session_start();
error_reporting(0);
include "config/regisConfig.php"
?>
        ...
        <div class="section mb-5 p-2">
            <form id="registerForm" action="" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <input type="email" class="form-control" id="email1" name="email" placeholder="Your email" value="<?= $email ?>">
                                <i class="clear-input">
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                <label class="label" for="reff">Referral (Opsional)</label>
                                <input type="text" class="form-control" id="reff" name="reff" placeholder="Your Refferal" value="<?= $upline ?>">
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
                ...
                <div class="form-button-group transparent">
                    <button type="submit" class="btn btn-success btn-block btn-lg" name="registrasi" onclick="loadingForm()">Register</button>
                </div>
        ...
        <div id="alertdanger" class="notification-box">
            <div class="notification-dialog ios-style bg-danger">
                ...
                <div class="notification-content">
                    <div class="in">
                        <h3 class="subtitle">Registrasi Gagal!</h3>
                        <div class="text">
                            <?= $alert_error ?>
                        </div>
                    </div>
