...
session_start();
error_reporting(0);
include "config/withdrawConfig.php"
?>
...
<body class="dark-mode">
    ...
    <div id="appCapsule">
        ...
        ?>
            ...
            <div class="modal fade action-sheet" id="withdrawActionSheet<?= $row['withdraw_id'] ?>" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Konfirmasi Withdraw</h5>
                        </div>
                        <div class="modal-body">
                            <div class="action-sheet-content">
                                <form method="post" action="">
                                    ...
                                    <input type="hidden" name="idWd" value="<?= $row['withdraw_id'] ?>">
    ...
    <div class="appBottomMenu">
        ...
        <a href="withdraw" class="item active">
            <div class="col">
