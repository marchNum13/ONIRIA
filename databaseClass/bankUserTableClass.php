<?php
// CLASS TABLE
class bankUserTableClass extends connMySQLClass{
    
    // SET ATTRIBUTE TABLE NAME
    private $table_name = "bank_user";
    ...
    // insert data
    public function insertBanktUser(string $fields, string $value){
        // query
    ...
    // get data
    public function selectBanktUser(string $fields, string $key){
        // query
    ...
    // update data
    public function updateBanktUser(string $dataSet, string $key){
        // query
