<?php
// CLASS TABLE
class bankAdminTableClass extends connMySQLClass{
    
    // SET ATTRIBUTE TABLE NAME
    private $table_name = "bank_admin";
    ...
    // insert data
    public function insertBanktAdmin(string $fields, string $value){
        // query
    ...
    // get data
    public function selectBanktAdmin(string $fields, string $key){
        // query
    ...
    // update data
    public function updateBanktAdmin(string $dataSet, string $key){
        // query
